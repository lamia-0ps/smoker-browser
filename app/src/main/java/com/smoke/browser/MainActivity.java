...
public class MainActivity extends AppCompatActivity {
    ...
    private void startMyBrowser() {
        ...
        final android.view.View btnMenu = findViewById(R.id.btn_menu);
  ...
  // Download listener & Downloader   
        ...
        btnMenu.setOnClickListener(v -> {
            ...
            androidx.cardview.widget.CardView m1 = createCardButton("🔥 WORK WITH SMOKER", 0xFFFFFFFF, 0xFFFF7043, false, false);
            menuRoot.addView(m1);
            ...
            m1.setOnClickListener(v12 -> { menuDlg.dismiss(); showSmokerBotsDialog(myBrowser); });
    ...
    private void saveBase64ToFile(String base64Data, String mimeType, String fileName) {
        runOnUiThread(() -> {
            try {
                ...
                if (dm != null) {
                    dm.addCompletedDownload(currentName, "Smoker Local Download", true, mimeType, file.getAbsolutePath(), file.length(), true);
                }
    ...
    private void setupDownloadSystem(final android.webkit.WebView webview) {
        ...
        webview.setDownloadListener((url, userAgent, contentDisposition, mimetype, contentLength) -> {
            ...
            if (url.startsWith("blob:")) {
                ...
                "           SmokeBlobDownloader.saveBase64(reader.result, '"+finalMimeType+"', '"+fileName+"');" +
                "       }" +
                "   }" +
                "};" +
                "xhr.send();" +
            ...
            try {
                ...
                request.setDescription("Smoker is downloading...");
